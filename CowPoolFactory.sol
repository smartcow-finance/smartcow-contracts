...
// File: contracts/CowPoolInitializable.sol

pragma solidity 0.6.12;

contract CowPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public COW_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == COW_POOL_FACTORY, "Not factory");
...
// File: contracts/CowPoolFactory.sol

pragma solidity 0.6.12;

contract CowPoolFactory is Ownable {
    event NewCowPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(CowPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        CowPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewCowPoolContract(smartChefAddress);
    }
}
